...
export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'mk-app-column-detail',
		children: [{
			name: 'form',
			component: 'Form',
			className: 'mk-app-column-detail-form',
			children: [{
				name: 'fieldNameItem',
				component: 'Form.Item',
				label: '字段名称',
				...
				children: [{
					...
					onChange: "{{(e)=>$fieldChange('data.form.fieldName',e.target.value)}}"
				}]
			},{
				name: 'captionItem',
				component: 'Form.Item',
				...
				children: [{
					...
					onChange: "{{(e)=>$fieldChange('data.form.caption',e.target.value)}}"
				}]
			},{
				name: 'fieldTypeItem',
				component: 'Form.Item',
				...
				children: [{
					...
					onChange: "{{(v)=>$setField('data.form.idFieldType', v)}}",
					children: {
						name: 'option',
				...
				children: [{
					...
					onChange: `{{(v)=>$fieldChange('data.form.width',v)}}`
				}]
			},{
				...
				children: [{
					...
					onChange: `{{(v)=>$fieldChange('data.form.defPrecision',v)}}`
				}]
			},{
				name: 'alignItem',
				component: 'Form.Item',
				...
				children: [{
					...
					onChange: "{{(v)=>$setField('data.form.idAlignType', v)}}",
					children: {
						name: 'option',
						component: 'Select.Option',
				...
				children: [{
					...
					onChange: "{{(v)=>$setField('data.form.idOrderMode', v)}}",
					children: {
						name: 'option',
						component: 'Select.Option',
				...
				children: [{
					...
					onChange: `{{(v)=>$fieldChange('data.form.colIndex',v)}}`
				}]
			},{
				name: 'isFixedItem',
				component: 'Form.Item',
				...
				children: [{
					...
					onChange: `{{(e)=>$fieldChange('data.form.isFixed', e.target.checked)}}`
				}]
			},{
				name: 'isVisibleItem',
				component: 'Form.Item',
				...
				children: [{
					...
					onChange: `{{(e)=>$fieldChange('data.form.isVisible', e.target.checked)}}`
				}]
			},{
				...
				children: [{
					...
					onChange: `{{(e)=>$fieldChange('data.form.isMustSelect', e.target.checked)}}`
				}]
			},{
				name: 'isSystemItem',
				component: 'Form.Item',
				...
				children: [{
					...
					onChange: `{{(e)=>$fieldChange('data.form.isSystem', e.target.checked)}}`
				}]
			}]
		}]
	}
