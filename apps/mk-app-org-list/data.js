export function getMeta() {
	return {
		name: 'root',
		component: 'Layout',
		className: 'mk-app-org-list',
		children: [{
			name: 'header',
			component: 'Layout',
			className: 'mk-app-org-list-header',
			children: [{
				name: 'left',
				component: 'Layout',
				className: 'mk-app-org-list-header-left',
				children: ['姓名:', {
					name: 'name',
					component: 'Input',
					placeholder: '请输入姓名查询',
			...
			name: 'content',
			className: 'mk-app-org-list-content',
			component: 'Layout',
			children: [{
				name: 'dataGrid',
				component: 'DataGrid',
			...
			name: 'footer',
			className: 'mk-app-org-list-footer',
			component: 'Layout',
			children: [{
				name: 'pagination',
